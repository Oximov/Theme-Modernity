                    ...
                    @forelse($category->packages as $package)
                        <div class="col-md-4 mb-4">
                            <div class="card h-100">
                                ...
                                @endif
                                <div class="card-body">
                                    <h4 class="card-title" style="text-align:center;">{{ $package->name }}</h4>
                                    <h5 style="text-align:center;">{{ shop_format_amount($package->price) }}</h5>
                                    <a href="#" class="btn shop-btn btn-block" data-package-url="{{ route('shop.packages.show', $package) }}">{{ trans('shop::messages.buy') }}</a>
                                </div>
                            </div>
                        </div>
                    @empty
