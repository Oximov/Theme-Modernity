...
@section('content')
    <div class="container content">
        ...
        <h2 class="vote-title">{{ trans('vote::messages.sections.vote') }}</h2>
        ...
        <div class="vote vote-now text-center position-relative mb-4 px-3 py-5 border rounded">
            ...
            <div class="@guest d-none @endguest h-100" data-vote-step="2">
                ...
                @forelse($sites as $site)
                    <a class="btn btn-primary vote-btn" href="{{ $site->url }}" target="_blank" rel="noopener noreferrer" data-site-url="{{ route('vote.vote', $site) }}">{{ $site->name }}</a>
                @empty
        ...
        <h2 class="vote-title">{{ trans('vote::messages.sections.top') }}</h2>
